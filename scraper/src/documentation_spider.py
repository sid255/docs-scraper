...
class DocumentationSpider(CrawlSpider, SitemapSpider):
    ...
    def __init__(self, config, elasticsearch_helper, strategy, *args, **kwargs):
        # Scrapy config
        ...
        self.elasticsearch_helper=elasticsearch_helper
    ...
    def add_records(self, response, from_sitemap):
        ...
        self.elasticsearch_helper.add_records(records, response.url, from_sitemap)
